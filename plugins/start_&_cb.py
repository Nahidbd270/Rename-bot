...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("♻ ᴅᴇᴠᴇʟᴏᴘᴇʀ ♻", url='https://telegram.me/ctgmovies23')]
    ])
    if Config.START_PIC:
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview = True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("👨‍💻  ʀᴇᴘᴏ", url="https://t.me/AllBotUpdatemy"),
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview = True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🤖 ᴍᴏʀᴇ ʙᴏᴛs", url="https://t.me/AllBotUpdatemy")],
        ...
        if len(str(user_id)) == 10:
            ...
            try:
                await client.send_message(user_id , f"<b>ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ʙʏ [ʀᴀʜᴜʟ](https://telegram.me/CtgmoviesAdminbot)\nʀᴇᴀsᴏɴ : {reason}</b>")
        ...
        if len(str(user_id)) == 10:
            try:
                unban_text = "<b>ʜᴜʀʀᴀʏ..ʏᴏᴜ ᴀʀᴇ ᴜɴʙᴀɴɴᴇᴅ ʙʏ [ʀᴀʜᴜʟ](https://telegram.me/CtgmoviesAdminbot)</b>"
